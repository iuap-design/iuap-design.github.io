...
u.DateTimePicker.fn.show = function(evt){
    ...
    if (!this._panel){
        ...
        // }else{
        //     this._headerYear.style.cursor = 'default';
        //     this._headerMonth.style.cursor = 'default';
        // }
    ...
    if(!u.isMobile){
        //调整left和top
        var off = u.getOffset(this.element);
        var left = off.left;
        var inputHeight = this.element.offsetHeight;
        var top = off.top + inputHeight;
        
        var oH = this._panel.offsetHeight;
        var oW = this._panel.offsetWidth;
