...
<div class="example-content"><div class="u-loading is-active u-loading-single-color"></div>
</div>
<div class="examples-code"><pre><code>&lt;div class="u-loading is-active u-loading-single-color">&lt;/div></code></pre>
</div>
