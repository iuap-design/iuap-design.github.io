...
return e.edit.enable?null:E.apply(C,arguments)};var I=C.removeNode;C.removeNode=function(e,t){var n=m.getRoot(e);n.curEditNode===t&&(n.curEditNode=null),I&&I.apply(C,arguments)};var w=C.selectNode;C.selectNode=function(t,n,o){e("#"+t.treeId+" a").removeClass("focusNode"),e("#"+n.tId+"_a").addClass("focusNode");var a=m.getRoot(t);return(!m.isSelectedNode(t,n)||a.curEditNode!=n||!n.editNameFlag)&&(w&&w.apply(C,arguments),C.addHoverDom(t,n),!0)};var S=N.uCanDo;N.uCanDo=function(e,t){var n=m.getRoot(e);return!(!t||!(N.eqs(t.type,"mouseover")||N.eqs(t.type,"mouseout")||N.eqs(t.type,"mousedown")||N.eqs(t.type,"mouseup")))||(n.curEditNode&&(C.editNodeBlur=!1,n.curEditInput.focus()),!n.curEditNode&&(!S||S.apply(C,arguments)))}}(jQuery);