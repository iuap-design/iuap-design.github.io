...
var obj = {
    core: ['custom/src/core/core/core.js',
            'custom/src/core/base/base.js',
            'custom/src/core/base/compMgr.js',
            'custom/src/core/core/jsExtensions.js',
            'custom/src/core/utils/i18n.js'],
    ajax: ['custom/src/core/ajax/ajax.js'],
    event: ['custom/src/core/core/event.js'],
    renderUtil: ['custom/src/core/utils/dataRender.js'],
    dateUtil: ['custom/src/core/utils/dateUtils.js'],
    formater: ['custom/src/core/utils/formater.js'],
    hotKeys: ['custom/src/core/utils/hotKeys.js'],
    masker: ['custom/src/core/utils/masker.js'],
    rsautils: ['custom/src/core/utils/rsautils.js'],
    model: ['custom/src/model/core/core.js',
            'custom/src/model/core/app.js',
            'custom/src/model/dataTable/dataTable.js'],
    polyfill: ['hasPolyfill'],
    ui: ['custom/src/ui/base/BaseComponent.js',
         'custom/src/ui/end.js'],
    textfield: ['custom/src/ui/textfield/textfield.js'],
    clockpicker: ['custom/src/ui/clockpicker/clockpicker.js'],
    time: ['custom/src/ui/time/time.js'],
    datetimepicker: ['custom/src/ui/datetimepicker/datetimepicker.js'],
    year: ['custom/src/ui/year/year.js'],
    month: ['custom/src/ui/month/month.js'],
    yearmonth: ['custom/src/ui/yearmonth/yearmonth.js'],
    checkbox: ['custom/src/ui/checkbox/checkbox.js'],
    combobox: ['custom/src/ui/combobox/combo.js',
                'custom/src/ui/combobox/combobox.js'],
    radio: ['custom/src/ui/radio/radio.js'],
    autocomplete: ['custom/src/ui/autocomplete/autocomplete.js'],
    switch: ['custom/src/ui/switch/switch.js'],
    button: ['custom/src/ui/button/button.js'],
    dialog: [ 
            'custom/src/ui/dialog/messageDialog.js',
            'custom/src/ui/dialog/confirmDialog.js',
            'custom/src/ui/dialog/threeBtnDialog.js',
            'custom/src/ui/dialog/dialog.js'],
    message: ['custom/src/ui/message/message.js'],
    loading: ['custom/src/ui/loading/loading.js'],
    menu: ['custom/src/ui/menu/menu.js'],
    pagination: ['custom/src/ui/pagination/pagination.js'],
    progress: ['custom/src/ui/progress/progress.js'],
    datatable: ['custom/src/ui/datatable/data-table.js'],
    // grid: ['custom/src/ui/grid/gridComp.js'],
    // tree: ['custom/src/ui/tree/treeComp.js'],
    grid: ['hasGrid'],
    tree: ['hasTree'],
    backtop: ['custom/src/ui/backtop/backtop.js'],
    tooltip: ['custom/src/ui/tooltip/tooltip.js'],
    multilang: ['custom/src/ui/multilang/multilang.js'],
    palette: [],
    refer: ['custom/src/ui/refer/refer.js'],
    ripple: ['custom/src/ui/ripple/ripple.js'],
    shadow: [],
    tabs: ['custom/src/ui/tabs/tabs.js'],
    card: [],
    navlayout: ['custom/src/ui/navlayout/navlayout.js'],
    gridlayout: [],
    mdlayout: ['custom/src/ui/mdlayout/mdlayout.js'],
    validate: ['custom/src/ui/validate/validate.js'],
    palette: [],
    // resets: [],
    gridBase:['custom/src/ui/grid/gridComp.js'],
    ColumnMenu:['custom/src/ui/grid/ColumnMenu.js'],
    Drag:['custom/src/ui/grid/Drag.js'],
    Edit:['custom/src/ui/grid/Edit.js'],
    EditForm:['custom/src/ui/grid/EditForm.js'],
    Fixed:['custom/src/ui/grid/Fixed.js'],
    // FormShow:['custom/src/ui/grid/FormShow.js'],
    HeaderLevel:['custom/src/ui/grid/HeaderLevel.js'],
    OverWidthHidden:['custom/src/ui/grid/OverWidthHidden.js'],
    Sort:['custom/src/ui/grid/Sort.js'],
    SumRow:['custom/src/ui/grid/SumRow.js'],
    Swap:['custom/src/ui/grid/Swap.js'],
    Tree:['custom/src/ui/grid/Tree.js'],
}
...
var modeluiObj = {
    model: ['custom/src/model/comp-adp/mixins/enableMixin.js',
            'custom/src/model/comp-adp/mixins/requiredMixin.js',
            'custom/src/model/comp-adp/mixins/validateMixin.js',
            'custom/src/model/comp-adp/mixins/valueMixin.js',
            'custom/src/model/comp-adp/baseAdapter.js'],
    checkbox: ['custom/src/model/comp-adp/checkbox.js'],
    combobox: ['custom/src/model/comp-adp/combobox.js'],
    textfield: ['custom/src/model/comp-adp/float.js',
                'custom/src/model/comp-adp/currency.js',
                'custom/src/model/comp-adp/integer.js',
                'custom/src/model/comp-adp/percent.js',
                'custom/src/model/comp-adp/string.js',
                'custom/src/model/comp-adp/textarea.js',
                'custom/src/model/comp-adp/textfield.js',],
    datetimepicker: ['custom/src/model/comp-adp/datetime.js'],
    month: ['custom/src/model/comp-adp/month.js'],
    // grid: ['custom/src/model/comp-adp/grid.js'],
    // multilang: ['custom/src/model/comp-adp/multilang.js'],
    pagination: ['custom/src/model/comp-adp/pagination.js'],
    progress: ['custom/src/model/comp-adp/progress.js'],
    radio: ['custom/src/model/comp-adp/radio.js'],
    switch: ['custom/src/model/comp-adp/switch.js'],
    time: ['custom/src/model/comp-adp/time.js'],
    // tree: ['custom/src/model/comp-adp/tree.js'],
    year: ['custom/src/model/comp-adp/year.js'],
    yearmonth: ['custom/src/model/comp-adp/yearmonth.js'],
}
