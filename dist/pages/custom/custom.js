...
var obj = {
    core: ['src/iuap-design/js/core/core.js',
            'src/iuap-design/js/core/base.js',
            'src/iuap-design/js/core/compMgr.js',
            'src/iuap-design/js/core/jsExtensions.js',
            'src/iuap-design/js/utilities/i18n.js'],
    ajax: ['src/iuap-design/js/core/ajax.js'],
    event: ['src/iuap-design/js/core/event.js'],
    renderUtil: ['src/iuap-design/js/utilities/dataRender.js'],
    dateUtil: ['src/iuap-design/js/utilities/dateUtils.js'],
    formater: ['src/iuap-design/js/utilities/formater.js'],
    hotKeys: ['src/iuap-design/js/utilities/hotKeys.js'],
    masker: ['src/iuap-design/js/utilities/masker.js'],
    rsautils: ['src/iuap-design/js/utilities/rsautils.js'],
    model: ['src/datatable/js/app.js',
            'src/datatable/js/dataTable.js'],
    polyfill: ['hasPolyfill'],
    ui: ['src/iuap-design/js/core/BaseComponent.js',
         'src/iuap-design/js/core/end.js'],
    textfield: ['src/iuap-design/js/ui.textfield.js'],
    clockpicker: ['src/../../../src/datetimepicker/css/js/clockpicker.js'],
    time: ['src/../../../src/datetimepicker/css/js/time.js'],
    datetimepicker: ['src/../../../src/datetimepicker/css/js/datetimepicker.js'],
    year: ['src/../../../src/datetimepicker/css/js/year.js'],
    month: ['src/../../../src/datetimepicker/css/js/month.js'],
    yearmonth: ['src/../../../src/datetimepicker/css/js/yearmonth.js'],
    checkbox: ['src/iuap-design/js/ui.checkbox.js'],
    combobox: ['src/iuap-design/js/ui.combo.js'],
    radio: ['src/iuap-design/js/ui.radio.js'],
    autocomplete: ['src/iuap-design/js/extend/autocomplete.js'],
    switch: ['src/iuap-design/js/ui.switch.js'],
    button: ['src/iuap-design/js/ui.button.js'],
    dialog: [ 
            'src/iuap-design/js/extend/messageDialog.js',
            'src/iuap-design/js/extend/confirmDialog.js',
            'src/iuap-design/js/extend/dialog.js'],
    message: ['src/iuap-design/js/ui.message.js'],
    loading: ['src/iuap-design/js/ui.loading.js'],
    menu: ['src/iuap-design/js/ui.menu.js'],
    pagination: ['src/iuap-design/js/ui.pagination.js'],
    progress: ['src/iuap-design/js/ui.progress.js'],
    datatable: ['src/iuap-design/js/ui.table.js'],
    // grid: ['src/grid/js/gridComp.js'],
    // tree: ['custom/src/ui/tree/treeComp.js'],
    grid: ['hasGrid'],
    tree: ['hasTree'],
    tooltip: ['src/iuap-design/js/ui.tooltip.js'],
    multilang: ['src/iuap-design/js/ui.multilang.js'],
    palette: [],
    refer: ['src/iuap-design/js/ui.refer.js'],
    ripple: ['src/iuap-design/js/ripple.js'],
    shadow: [],
    tabs: ['src/iuap-design/js/ui.tabs.js'],
    card: [],
    navlayout: ['src/iuap-design/js/layout.nav.js'],
    gridlayout: [],
    mdlayout: ['src/iuap-design/js/layout.md.js'],
    validate: ['src/iuap-design/js/validate.js'],
    palette: [],
    // resets: [],
    gridBase:['src/grid/js/gridComp.js'],
    ColumnMenu:['src/grid/js/ColumnMenu.js'],
    Drag:['src/grid/js/Drag.js'],
    Edit:['src/grid/js/Edit.js'],
    EditForm:['src/grid/js/EditForm.js'],
    Fixed:['src/grid/js/Fixed.js'],
    // FormShow:['src/grid/js/FormShow.js'],
    HeaderLevel:['src/grid/js/HeaderLevel.js'],
    OverWidthHidden:['src/grid/js/OverWidthHidden.js'],
    Sort:['src/grid/js/Sort.js'],
    SumRow:['src/grid/js/SumRow.js'],
    Swap:['src/grid/js/Swap.js'],
    Tree:['src/grid/js/Tree.js'],
}
...
var cssObj = {
    ui:['@import "../../../src/iuap-design/scss/mixins/variables.scss"','@import "../../../src/iuap-design/scss/mixins/mixins.scss"'],
    autocomplete: ['@import "../../../src/iuap-design/scss/extend/autocomplete.scss"'],
    button: ['@import "../../../src/iuap-design/scss/ui.button.scss"'],
    card: ['@import "../../../src/iuap-design/scss/card.scss"'],
    checkbox: ['@import "../../../src/iuap-design/scss/ui.checkbox.scss"'],
    clockpicker: ['@import "clockpicker/clockpicker.scss"','@import "../../../src/iuap-design/scss/ui.combo.scss"'],
    month:['@import "../../../src/iuap-design/scss/ui.combo.scss"','@import "../../../src/datetimepicker/css/datetimepicker.scss"','@import "../../../src/iuap-design/scss/ui.textfield.scss"'],
    combobox: ['@import "../../../src/iuap-design/scss/ui.combo.scss"'],
    datatable: ['@import "../../../src/iuap-design/scss/ui.table.scss"'],
    datetimepicker: ['@import "../../../src/datetimepicker/css/datetimepicker.scss"'],
    dialog: [ '@import "../../../src/iuap-design/scss/extend/dialog.scss"'],
    // grid: ['@import "grid/gridComp.scss"'],
    gridlayout: ['@import "../../../src/iuap-design/scss/layout.grid.scss"'],
    loading: ['@import "../../../src/iuap-design/scss/ui.loading.scss"'],
    mdlayout: ['@import "../../../src/iuap-design/scss/layout.md.scss"'],
    menu: ['@import "../../../src/iuap-design/scss/ui.menu.scss"'],
    message: ['@import "../../../src/iuap-design/scss/ui.message.scss"'],
    navlayout: ['@import "../../../src/iuap-design/scss/layout.nav.scss"'],
    pagination: ['@import "../../../src/iuap-design/scss/ui.pagination.scss"'],
    palette: ['@import "../../../src/iuap-design/scss/palette.scss"'],
    progress: ['@import "../../../src/iuap-design/scss/ui.progress.scss"'],
    radio: ['@import "../../../src/iuap-design/scss/ui.radio.scss"'],
    ripple: ['@import "../../../src/iuap-design/scss/ripple.scss"'],
    shadow: ['@import "shadow/shadow.scss"'],
    tabs: ['@import "../../../src/iuap-design/scss/ui.tabs.scss"'],
    textfield: ['@import "../../../src/iuap-design/scss/ui.textfield.scss"'],
    time: ['@import "../../../src/datetimepicker/css/time.scss"','@import "../../../src/iuap-design/scss/ui.combo.scss"','@import "../../../src/iuap-design/scss/ui.textfield.scss"','@import "../../../src/iuap-design/scss/ui.button.scss"'],
    year:['@import "../../../src/iuap-design/scss/ui.textfield.scss"','@import "../../../src/iuap-design/scss/ui.combo.scss"','@import "../../../src/iuap-design/scss/ui.button.scss"','@import "../../../src/datetimepicker/css/datetimepicker.scss"'],
    yearmonth:['@import "../../../src/iuap-design/scss/ui.textfield.scss"','@import "../../../src/iuap-design/scss/ui.combo.scss"','@import "../../../src/iuap-design/scss/ui.button.scss"','@import "../../../src/datetimepicker/css/datetimepicker.scss"'],
    tooltip: ['@import "../../../src/iuap-design/scss/ui.tooltip.scss"'],
    // tree: ['@import "tree/tree.scss"'],
    switch: ['@import "../../../src/iuap-design/scss/ui.switch.scss"'],
    palette: ['@import "../../../src/iuap-design/scss/palette.scss"'],
    // resets: ['@import "resets/resets.scss"'],
}

var modeluiObj = {
    model: ['src/datatable/js/dtJs/mixins/enableMixin.js',
            'src/datatable/js/dtJs/mixins/requiredMixin.js',
            'src/datatable/js/dtJs/mixins/validateMixin.js',
            'src/datatable/js/dtJs/mixins/valueMixin.js',
            'src/datatable/js/dtJs/baseAdapter.js'],
    checkbox: ['src/datatable/js/dtJs/checkbox.js'],
    combobox: ['src/datatable/js/dtJs/combobox.js'],
    textfield: ['src/datatable/js/dtJs/float.js',
                'src/datatable/js/dtJs/currency.js',
                'src/datatable/js/dtJs/integer.js',
                'src/datatable/js/dtJs/percent.js',
                'src/datatable/js/dtJs/string.js',
                'src/datatable/js/dtJs/textarea.js',
                'src/datatable/js/dtJs/textfield.js',],
    datetimepicker: ['src/datatimepicker/js/dtJs/datetime.js'],
    month: ['src/datatimepicker/js/dtJs/month.js'],
    // grid: ['src/datatable/js/dtJs/grid.js'],
    // multilang: ['src/datatable/js/dtJs/multilang.js'],
    pagination: ['src/datatable/js/dtJs/pagination.js'],
    progress: ['src/datatable/js/dtJs/progress.js'],
    radio: ['src/datatable/js/dtJs/radio.js'],
    switch: ['src/datatable/js/dtJs/switch.js'],
    time: ['src/datatimepicker/js/dtJs/time.js'],
    // tree: ['src/datatable/js/dtJs/tree.js'],
    year: ['src/datatimepicker/js/dtJs/year.js'],
    yearmonth: ['src/datatimepicker/js/dtJs/yearmonth.js'],
}
...
function clickFun(){
    ...
    u.ajax({
        ...
        success:function(patch){
			...
			patch = patch.replace('root/custom/','')
