...
var obj = {
    core: ['../bin/iuap-design/js/core/core.js',
            ...
            '../bin/iuap-design/js/core/jsExtensions.js',
    ...
    model: ['../bin/datatable/js/app.js',
            '../bin/datatable/js/dataTable.js'],
    ...
    clockpicker: ['../bin/../../../bin/datetimepicker/css/js/clockpicker.js'],
    time: ['../bin/../../../bin/datetimepicker/css/js/time.js'],
    datetimepicker: ['../bin/../../../bin/datetimepicker/css/js/datetimepicker.js'],
    year: ['../bin/../../../bin/datetimepicker/css/js/year.js'],
    month: ['../bin/../../../bin/datetimepicker/css/js/month.js'],
    yearmonth: ['../bin/../../../bin/datetimepicker/css/js/yearmonth.js'],
    ...
    // grid: ['../bin/grid/js/gridComp.js'],
    // tree: ['custom/../bin/ui/tree/treeComp.js'],
    grid: ['hasGrid'],
    tree: ['hasTree'],
    ...
    // FormShow:['../bin/grid/js/FormShow.js'],
...
var modeluiObj = {
    model: ['../bin/datatable/js/dtJs/mixins/enableMixin.js',
            '../bin/datatable/js/dtJs/mixins/requiredMixin.js',
            '../bin/datatable/js/dtJs/mixins/validateMixin.js',
            '../bin/datatable/js/dtJs/mixins/valueMixin.js',
            '../bin/datatable/js/dtJs/baseAdapter.js'],
    checkbox: ['../bin/datatable/js/dtJs/checkbox.js'],
    combobox: ['../bin/datatable/js/dtJs/combobox.js'],
    textfield: ['../bin/datatable/js/dtJs/float.js',
                '../bin/datatable/js/dtJs/currency.js',
                '../bin/datatable/js/dtJs/integer.js',
                '../bin/datatable/js/dtJs/percent.js',
                '../bin/datatable/js/dtJs/string.js',
                '../bin/datatable/js/dtJs/textarea.js',
                '../bin/datatable/js/dtJs/textfield.js',],
    datetimepicker: ['../bin/datatimepicker/js/dtJs/datetime.js'],
    month: ['../bin/datatimepicker/js/dtJs/month.js'],
    // grid: ['../bin/datatable/js/dtJs/grid.js'],
    // multilang: ['../bin/datatable/js/dtJs/multilang.js'],
    pagination: ['../bin/datatable/js/dtJs/pagination.js'],
    progress: ['../bin/datatable/js/dtJs/progress.js'],
    radio: ['../bin/datatable/js/dtJs/radio.js'],
    switch: ['../bin/datatable/js/dtJs/switch.js'],
    time: ['../bin/datatimepicker/js/dtJs/time.js'],
    // tree: ['../bin/datatable/js/dtJs/tree.js'],
